...
public class CLGConfigGui extends GuiConfig {
	public CLGConfigGui(GuiScreen parent) {
		super(parent, new ConfigElement(
				CLGReference.cfg.getCategory(Configuration.CATEGORY_GENERAL))
				.getChildElements(), CLGReference.modid, false, false,
				GuiConfig.getAbridgedConfigPath(CLGReference.cfg.toString()));
	}

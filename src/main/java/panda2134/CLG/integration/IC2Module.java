	...
	public void setIC2CompatRecipes(){
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(
				...
				new Object[]{
					...
					'l', new ItemStack(Ic2Items.lapotronCrystal.getItem(),
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(
				...
				new Object[]{
					...
					'p', Ic2Items.carbonPlate,
					'e', new ItemStack(Ic2Items.energyCrystal.getItem(),
							1,OreDictionary.WILDCARD_VALUE),
					'm', Ic2Items.miningPipe,
					'g', Ic2Items.geothermalGenerator
		}));
		//ClGCasing
		GameRegistry.addRecipe(new ShapedOreRecipe(
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(
					...
					new Object[]{
						...
						'e', Ic2Items.energiumDust,
						'c', Blocks.blockCasing,
						'g', Ic2Items.glassFiberCableItem,
						'n', new ItemStack(Ic2Items.energyCrystal.getItem(),
								1,OreDictionary.WILDCARD_VALUE)
		}));
		//CLGHammer

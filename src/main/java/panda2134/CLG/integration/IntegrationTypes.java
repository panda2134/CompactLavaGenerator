...
public enum IntegrationTypes {
	IC2(IC2Module.class,Mods.IC2),
	CofhAPIEnergy(RFEnergyModule.class,Mods.cofhApiEnergy),
	ThermalExpansion(TEModule.class,Mods.ThermalExpansion),
	Factorization(FZModule.class,Mods.Factorization);
